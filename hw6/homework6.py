'''
დაწერეთ პროგრამა, რომელიც ტერმინალში მომხმარებელს გამოუტანს სტუდენტების აიდის (id) სიას, მომხარებელი აირჩევს სტუდენტის აიდის,
მიღებული აიდისთვის დაბეჭდავს სტუდენტის მონაცემებს. მონაცემებში უნდა დაიბეჭდოს (სახელი, გვარი, ასაკი და ქულა თითოეული საგნის მიხედვით)
...
print(f"სტუდენტების ID: {', '.join(student_ids)}")

chosen_id = input("აირჩიეთ სტუდენტების ID: ").strip()
...
if student is None:
    print("სტუდენტი არ მოიძებნება")
else:
    print("\nსტუდენტის ინფორმაცია:")
    print(f"ID: {student['id']}, სახელი: {student['name']}, ასაკი: {student['age']}")

    for subject in my_dict["subjects"]:
        grade = subject["grades"].get(chosen_id, 'N/A')
        print(f"საგანი: {subject['name']}, ქულა: {grade}")
